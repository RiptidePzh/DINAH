...
import queue
import time
from performance import create_data_dashboard
...
class Backtest(object):
    ...
    def _run_backtest(self):
        ...
        while True:
            ...
            if self.data_handler.continue_backtest == True:
                ...
                print('market_date_updated:',self.data_handler.get_latest_bars(self.symbol_list[0])[0]['datetime'])
                print('total equity: ',self.portfolio.all_holdings[-1]['total'])
            else:
                break
    ...
    def _output_performance(self):
        ...
        create_data_dashboard(self.portfolio.equity_curve)
